...
def main():
    ...
    test_briefs = [
        {
            'filename': f'{briefs_dir}/brief_2024-01-15.pdf',
        ...
        {
            'filename': f'{briefs_dir}/brief_2024-01-14.pdf',
        ...
        {
            'filename': f'{briefs_dir}/brief_2024-01-13.pdf',
        ...
        {
            'filename': f'{briefs_dir}/brief_2024-01-12.pdf',
        ...
        {
            'filename': f'{briefs_dir}/brief_2024-01-11.pdf',
